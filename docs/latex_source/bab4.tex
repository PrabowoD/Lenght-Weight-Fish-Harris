...
Sebaliknya, area tubuh ikan yang relatif datar akan menghasilkan perubahan intensitas yang lebih kecil sehingga nilai autokorelasi juga menjadi lebih rendah.
...
Nilai referensi yang digunakan terdapat pada tabel~\ref{tab:Nilai Referensi}.

Setelah dilakukan evaluasi akurasi terhadap hasil deteksi panjang, lebar, dan estimasi berat ikan, ditemukan bahwa beberapa hasil estimasi berat ikan ada yang kurang, bahkan ada yang melebihi dari nilai referensi-nya. Hasil deteksi dapat dilihat pada tabel~\ref{tab:Hasil Deteksi}. %Hal ini disebabkan oleh beberapa faktor, yaitu:
...
Dengan Menggunakan rumus MAPE, didapatkan hasil evaluasi akurasi pada table~\ref{tab:MAPE} berikut:
...
Berdasarkan hasil evaluasi akurasi pada tabel~\ref{tab:MAPE} dan tabel~\ref{tab:allEval}, didapatkan sebuah kesimpulan bahwa sistem masih menghasilkan kesalahan dalam pengukuran pada beberapa citra ikan.
