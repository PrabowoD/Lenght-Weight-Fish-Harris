...
Langkah pertama yang dilakukan dalam penelitian adalah dengan memasukan \emph{dataset} untuk dilakukan \emph{pre-processing}. Dalam hal ini, gambar akan diberikan nama sesuai dengan jenis ikan, yaitu Mas, Lele, dan Nila Merah, dapat dilihat pada gambar~\ref{fig:folder-ikan}.
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[keepaspectratio, width=14cm]{gambar/ikan_Nila_Induk_1.jpg}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[keepaspectratio, width=14cm]{gambar/IMG_20240121_135842 - Copy.jpg}}
...
Setelah rotasi dilakukan dengan fungsi \emph{PCa\_Rotate\_image}, gambar akan memiliki bagian hitam hasil dari rotasi. Maka dari itu, bagian hitam akan di-isi dengan warna putih dengan menambahkan parameter \emph{borderValue} pada fungsi \emph{cv2.warpAffine}.
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[keepaspectratio, width=8cm]{gambar/ikan_Nila_Induk_1_output.jpg}}
        \caption{Sebelum rotasi}\label{fig:before-rotasi}
    \end{figure}

    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[keepaspectratio, width=8cm]{gambar/ikan_Nila_Induk_1_rotate2.jpg}}
...
Tanpa proses smoothing, noise kecil pada citra dapat menghasilkan perubahan intensitas palsu yang berpotensi menyebabkan munculnya titik sudut yang tidak sesuai pada proses Harris-Corner Detection, hasil dapat dilihat pada Gambar~\ref{fig:csvgradien_x}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/csv Gradient X.png}
...
Sebaliknya, area tubuh ikan yang relatif datar akan menghasilkan perubahan intensitas yang lebih kecil sehingga nilai autokorelasi juga menjadi lebih rendah, salah satu hasil autokorelasi dapat dilihat pada Gambar~\ref{fig:csvautokorelasi}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/csv Autokorelasi IXX.png}
