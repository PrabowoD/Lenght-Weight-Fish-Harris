...
%-----------------------------------------------------------------
\titleind{Pengukuran Panjang Ikan Dengan Metode Harris Corner Detection dan Estimasi Berat Ikan Menggunakan Length-Weight Relationship Berbasis Citra Digital}
...
\include{persetujuan}
\includepdf[pages=-]{skripsi/lembar pengesahan.pdf}
