...
\textbf{Prabowo Darmawi}, Pengukuran Panjang Ikan  Menggunakan Metode \emph{Harris-Corner Detection} dan Estimasi Berat Ikan Menggunakan Metode Turunan \emph{Length-Weight Relationship} Berbasis Citra Digital.
...
\\
    ...
    Dalam Budidaya ikan, pengukuran panjang dan berat ikan masih dilakukan secara manual. Hal ini menyebabkan turun nya kualitas ikan saat pemanenan berlangsung.
...
Teruntuk Data yang digunakan dalam penelitian berjumlah 32 gambar yang terbagi menjadi


Hasil dari penelitian ini adalah sebuah algoritma yang dapat menghitung panjang serta berat ikan berdasarkan input gambar.
\\
\\
